				...
				<div class="col-75">
					<div class="container_thanhtoan">
						<form action="MuaHang">
							...
							<input type="submit" value="Xác Nhận Thanh Toán" class="btn" >
						</form>
						<script>
					        function thongbao(){
				...
				<div class="col-25">
					<div class="container_thanhtoan">
						...
						<c:forEach items="${cart.getGioHang()}" var="sp">
							<p>
								<a href="#">${sp.tenSanpham }</a> <span class="price">SL: ${sp.soLuong }  ${sp.soLuong*sp.donGia}</span>
							</p>
							<br/>
						</c:forEach>
						...
						<p>
							Tổng tiền:  <span class="price" style="color: black"><b>
															...
															<fmt:formatNumber value="${cart.TongTien() }" type="currency"/></b></span>
						</p>
					</div>
				</div>
			</div>
