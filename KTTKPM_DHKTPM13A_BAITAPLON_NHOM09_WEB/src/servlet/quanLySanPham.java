...
public class quanLySanPham extends HttpServlet {
	...
	@EJB
	private NhaCungCapEJB_CRUDRemote nhacungcapEJB_CRUDRemote;
	@EJB
	private DonHangEJB_CRUDRemote donhangEJB_CRUDRemote ;
	@EJB
	private ChiTietDonHangEJB_CRUDRemote chitietEJB_CRUDRemote;
	...
	private void formSua(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("listDMSua", danhmucEJB_CRUDRemote.getAllDanhMuc());
		request.setAttribute("listNCCSua", nhacungcapEJB_CRUDRemote.getALLNCC());
	...
	private void suaSP(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		NhaCungCap n=nhacungcapEJB_CRUDRemote.getNhaCungCapbyTen(ncc);
		DanhMuc d=danhmucEJB_CRUDRemote.getDanhMucbyTen(dm);
		...
		request.setAttribute("list", sanPhamEJB_CRUDRemote.getAllSanPhambyTrangThai());
	...
	private void listChiTiet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("listchitiet",chitietEJB_CRUDRemote.getChiTietDonHang(Integer.parseInt(id)));
	...
	private void listDonHang(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		request.setAttribute("list",donhangEJB_CRUDRemote.getAllDonHang());
	...
	private void formThem(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		request.setAttribute("listDM", danhmucEJB_CRUDRemote.getAllDanhMuc());
		request.setAttribute("listNCC", nhacungcapEJB_CRUDRemote.getALLNCC());
